        ...
        <div class="space-y-2">
          ...
          <ul v-if="badge" class="text-left text-xs text-ink-600 dark:text-cream-100 space-y-0.5 border-t border-cream-200 dark:border-ash-700 pt-2">
            ...
            <li class="flex items-center gap-1.5 pt-1 border-t border-cream-200 dark:border-ash-700 mt-1">
              ...
              <span class="text-blue-600 dark:text-blue-400">{{ BADGE_TIERS[badge].imageModels[0] }}</span>
              <span class="text-ink-400 dark:text-ink-500">({{ BADGE_TIERS[badge].imageQuality }})</span>
            </li>
          </ul>
          <div class="flex justify-between">
