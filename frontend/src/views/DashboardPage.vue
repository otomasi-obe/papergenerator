<template>
 ...
 <div class="flex items-center gap-2 px-4 pb-4">
        <button @click="openPaper(paper)"
          class="flex-1 px-3 py-1.5 min-h-[36px] bg-navy-700 hover:bg-navy-800 dark:bg-cream-200 dark:hover:bg-cream-100 text-cream-50 dark:text-ash-900 text-xs rounded-lg transition font-medium active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#238f7f] focus-visible:ring-offset-2">
          Open
        </button>
        <button @click="copyPaper(paper)" :disabled="copying === paper.id"
          class="px-3 py-1.5 min-h-[36px] min-w-[36px] bg-cream-100 hover:bg-cream-200 dark:bg-ash-700 dark:hover:bg-ash-600 text-ink-700 dark:text-ink-100 text-xs rounded-lg transition disabled:opacity-50 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#238f7f] focus-visible:ring-offset-2"
          title="Copy paper">
          {{ copying === paper.id ? '...' : 'Copy' }}
        </button>
        <button @click="confirmDelete(paper)"
          class="px-3 py-1.5 min-h-[36px] min-w-[36px] border border-red-200 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 text-xs rounded-lg transition active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#238f7f] focus-visible:ring-offset-2"
          title="Delete paper">
          Delete
        </button>
 </div>
