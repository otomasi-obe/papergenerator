    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-cream-50/10 border border-cream-300/40 rounded-2xl p-8 backdrop-blur-sm">
          ...
          <div class="block">
            ...
            <div class="relative">
              ...
              <button
                ...
                class="absolute right-3 top-1/2 -translate-y-1/2 text-sm text-cream-200/80 hover:text-cream-50 transition-colors"
              >
        ...
        <button
          ...
          class="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white hover:bg-cream-100 text-navy-900 rounded-xl font-semibold transition-all shadow-lg text-sm active:scale-95 transition-transform border border-cream-300/40"
        >
      ...
      <div class="text-center mt-6">
        <router-link to="/" class="text-cream-200/80 hover:text-cream-200 text-sm transition-colors">
          ← Back to home
        </router-link>
      </div>
    </div>
