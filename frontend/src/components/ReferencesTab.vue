    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <div class="flex gap-2">
        ...
        <button @click="store.addReference()"
          class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium active:scale-95 transition-transform focus-visible:ring-2 focus-visible:ring-[#238f7f]/30">
          + Add Reference
        </button>
      </div>
    </div>
    ...
    <div class="mt-4 border rounded-lg bg-cream-50 p-4">
      ...
      <div class="flex gap-2">
        <input v-model="refPrompt" type="text"
          ...
          class="flex-1 px-3 py-1.5 border rounded text-sm focus-visible:ring-2 focus-visible:ring-[#238f7f]/30 outline-none"
          @keyup.enter="aiAddRefs" />
        <button @click="aiAddRefs"
          :disabled="store.aiLoading || !refPrompt.trim()"
          class="px-4 py-1.5 bg-purple-600 text-white rounded text-sm hover:bg-purple-700 disabled:opacity-50 active:scale-95 transition-transform focus-visible:ring-2 focus-visible:ring-[#238f7f]/30">
          Send
        </button>
      </div>
    </div>
