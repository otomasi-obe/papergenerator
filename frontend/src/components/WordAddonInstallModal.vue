      ...
      >
        ...
        >
          ...
          <header class="flex items-center justify-between px-6 pt-5 pb-3 border-b border-cream-300 dark:border-ash-700">
            ...
            <button
              type="button"
              class="min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-ink-500 dark:text-ink-300 hover:bg-cream-200 dark:hover:bg-ash-700 hover:text-ink-900 dark:hover:text-ink-50 transition-colors active:scale-95 transition-transform focus-visible:ring-2 focus-visible:ring-[#238f7f] focus-visible:ring-offset-2"
          ...
          <div class="px-6 py-5 space-y-5">
            ...
            <template v-if="activeTab === 'desktop'">
              ...
              <a
                :href="downloadUrl"
                class="inline-flex items-center gap-2 px-5 py-2.5 min-h-[44px] rounded-xl bg-navy-700 hover:bg-navy-800 dark:bg-cream-200 dark:hover:bg-cream-100 text-cream-50 dark:text-ash-900 text-sm font-medium transition-colors active:scale-95 transition-transform focus-visible:ring-2 focus-visible:ring-[#238f7f] focus-visible:ring-offset-2"
                download
              >
