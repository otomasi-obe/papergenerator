<template>
  <div class="p-6">
    <div class="flex items-center justify-between mb-4 max-w-5xl mx-auto">
      <div>
        <h2 class="text-lg font-semibold text-ink-900 dark:text-ink-50">Images</h2>
    ...
    <div class="max-w-5xl mx-auto mb-4 bg-cream-50 dark:bg-ash-800 border border-cream-300 dark:border-ash-700 rounded-xl shadow-sm overflow-hidden">
      ...
      <div class="p-4 flex gap-3">
        ...
        <button @click="generateImage" :disabled="!genPrompt.trim() || generating"
          class="px-4 py-2 bg-navy-600 hover:bg-navy-700 dark:bg-cream-200 dark:hover:bg-cream-100 text-cream-50 dark:text-ash-900 rounded-lg text-sm font-medium disabled:opacity-50 active:scale-95 transition-transform whitespace-nowrap flex items-center gap-1.5 focus-visible:ring-2 focus-visible:ring-[#238f7f]/30">
