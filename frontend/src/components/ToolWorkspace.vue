  ...
  <div class="space-y-4">
    ...
    <div class="mb-4 flex items-start justify-between">
      ...
      <button
        ...
        class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-red-500 dark:text-red-400 bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 border border-red-200 dark:border-red-800 transition-colors active:scale-95 shrink-0 mt-1"
    ...
    <div class="flex flex-wrap gap-2.5 items-center">
      ...
      <div v-if="store.activeTool?.id === 'translate'" class="flex items-center gap-2">
        ...
        <button
          @click="swapLanguages"
          class="p-2 rounded-full border border-cream-300 dark:border-ash-600 bg-cream-100 dark:bg-ash-700 text-ink-700 dark:text-ink-300 hover:bg-cream-200 dark:hover:bg-ash-600 transition-colors active:scale-90"
        ...
        <div class="flex items-center justify-between px-3.5 py-2.5 border-b border-cream-300 dark:border-ash-700 bg-cream-100 dark:bg-ash-700 text-xs font-semibold text-ink-900 dark:text-ink-50">
          ...
          <div class="flex items-center gap-1.5">
            <button
              ...
              class="px-3 py-1 rounded-md text-xs font-semibold bg-cream-200 dark:bg-ash-600 hover:bg-cream-300 dark:hover:bg-ash-500 text-ink-900 dark:text-ink-50 transition-colors active:scale-95"
              @click="copyOutput"
            >
              Copy
            </button>
          ...
          <div v-else-if="store.activeTool?.id === 'detector' && store.toolResult?.sentences?.length" class="space-y-3">
            ...
            <div class="space-y-1.5">
              <div
                ...
                :key="i"
                class="rounded-lg px-3 py-2 text-sm leading-relaxed border-l-3 transition-colors cursor-default"
