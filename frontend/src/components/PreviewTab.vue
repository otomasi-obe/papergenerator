<template>
 ...
 :class="['px-3 py-1 rounded-lg text-xs font-medium transition flex items-center gap-1 active:scale-95',
 editMode
 ...
 class="px-2 py-1 text-xs text-ink-700 dark:text-ink-200 hover:bg-cream-200 dark:hover:bg-ash-700 disabled:opacity-30 transition"
 ...
 class="px-2 py-1 text-xs text-ink-700 dark:text-ink-200 hover:bg-cream-200 dark:hover:bg-ash-700 border-l border-cream-300 dark:border-ash-600 transition"
 title="Reset zoom">↺</button>
 </div>
 <button @click="store.exportDocx()"
 class="px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 text-sm font-medium flex items-center gap-2 active:scale-95 ">
