...
<template>
  <div v-if="error" class="flex flex-col items-center justify-center min-h-[400px] p-8 text-center" role="alert">
    <div class="max-w-md">
      <h2 class="text-xl font-semibold text-ink-900 dark:text-ink-50 mb-2">Something went wrong</h2>
      <p class="text-sm text-ink-600 dark:text-ash-300 mb-4">{{ error.message }}</p>
