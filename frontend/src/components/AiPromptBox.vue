  ...
  <div class="mt-2 border rounded-lg bg-cream-50 p-3">
    ...
    <div class="flex gap-2">
      ...
      <button @click="generate"
        ...
        class="px-4 py-1.5 bg-[var(--accent)] text-white rounded text-sm hover:bg-[var(--accent)]/90 disabled:opacity-50 flex items-center gap-1 active:scale-95 transition-transform focus-visible:ring-2 focus-visible:ring-[#238f7f]/30">
