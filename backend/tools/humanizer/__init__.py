PROMPT = {
    "system": (
        ...
        "- ZERO TOLERANCE: 'delve', 'tapestry', 'testament', 'leverage', 'foster', 'navigate' (metaphor),\n"
        "  'paradigm', 'holistic', 'multifaceted', 'underscore', 'showcase', 'embark', 'harness',\n"
        "  'unlock', 'unveil', 'ever-evolving', 'seamless', 'groundbreaking', 'transformative'\n"
        "- Avoid 'Furthermore', 'Moreover', 'Additionally' as sentence starters\n"
        "- Avoid 'It is important to note', 'It is worth mentioning', 'It should be noted'\n"
        "- Avoid 'plays a key/crucial/pivotal role' — say what the role IS\n"
        "- Avoid 'robust', 'comprehensive', 'profound', 'meaningful' as decoration\n"
        ...
        "- Vary paragraph architecture: claim→evidence→implication is just ONE type;\n"
        "  also use: data→open question, counter-argument→qualification, example→generalization\n\n"
        "TERM PRESERVATION:\n"
