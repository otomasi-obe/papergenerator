"""
ICONIEgen.py - Generator DOCX untuk jurnal ICONIE.
Menggunakan dokumen asli ICONIE.docx sebagai base template.
...
def set_para_spacing(para, before_pt=None, after_pt=None, line_tw=360):
...
def add_abstract(doc, data):
    ...
    set_para_spacing(p_label, before_pt=6, after_pt=3, line_tw=276)
    run_label = p_label.add_run("Abstract")
    set_run_font(run_label, CFG["font_body"], CFG["size_body"], bold=True, italic=True)
    # Content
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.JUSTIFY
    set_para_spacing(p, before_pt=0, after_pt=6, line_tw=276)
...
def add_body_text(doc, text):
    ...
    bold_auto = cleaned.startswith("• ") or "Kontribusi spesifik" in cleaned or "Penelitian sebelumnya" in cleaned
