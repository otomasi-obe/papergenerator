"""
Springer Journal Template Generator

Generates papers in Springer journal format (single-column, numbered references).
Based on Springer Nature LaTeX/Word templates.
"""
...
TEMPLATE_PATH = BASE_DIR / "Springer.docx"
DEFAULT_OUTPUT_NAME = "Springer_output.docx"
...
def _add_authors(doc: Document, config: dict):
    ...
    for idx, author in enumerate(authors, start=1):
        ...
        if affiliation:
            affiliations.append(f"^{idx} {affiliation}")
...
def build_document(
    ...
    if output_path:
        ...
        final_output = json_path.parent / f"{json_path.stem}_Springer.docx"
