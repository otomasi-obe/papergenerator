...
TEMPLATE_REGISTRY: Dict[str, TemplateMetadata] = {
    ...
    "MURHUM": TemplateMetadata(
        code="MURHUM",
        name="Murhum",
        full_name="Murhum : Jurnal Pendidikan Anak Usia Dini",
        template_type=TemplateType.JOURNAL,
        fields=[TemplateField.MULTIDISCIPLINARY],
        citation_style=CitationStyle.APA,
        publisher="Perkumpulan Pengelola Jurnal (PPJ) PAUD Indonesia Koordinator Sulawesi",
        country="Indonesia",
        language="Indonesian/English",
        columns=1,
        page_size="A4",
        ...
        special_sections=["Title", "Author(s) & Affiliation", "Abstract", "Keywords", "Introduction", "Method", "Results and Discussion", "Conclusion", "Acknowledgments", "References"],
        notes="Jurnal Sinta 3 PAUD (SK 10/C/C3/DT.05.00/2025). e-ISSN 2723-6390. Single column, APA bodynote style. Font: Cambria 14pt title bold, 12pt body, 11pt abstract italic. Margin: left 25mm, right 20mm, top 30mm, bottom 20mm. 2 issue/tahun (Juli & Desember). APC Rp 1.000.000."
    ),
    "OBSESI": TemplateMetadata(
        ...
        fields=[TemplateField.MULTIDISCIPLINARY],
        citation_style=CitationStyle.APA,
        publisher="Universitas Pahlawan Tuanku Tambusai (UPTT), Bangkinang, Riau",
        country="Indonesia",
        ...
        supports_figures=True,
        supports_tables=True,
        special_sections=["Title", "Author(s) & Affiliation", "Abstract", "Keywords", "Introduction", "Method", "Results and Discussion", "Conclusion", "References"],
        notes="Jurnal Sinta 2 PAUD. p-ISSN 2356-1327, e-ISSN 2549-8959. DOI prefix 10.31004/obsesi. Single column, APA style. Font: Book Antiqua 14pt title bold, 12pt body, 10pt abstract. Abstract 150-250 kata. 6 issue/tahun. APC Rp 500.000."
    ),
    "PAUDIA": TemplateMetadata(
        code="PAUDIA",
        name="PAUDIA",
        full_name="PAUDIA : Jurnal Penelitian dalam Bidang Pendidikan Anak Usia Dini",
        template_type=TemplateType.JOURNAL,
        fields=[TemplateField.MULTIDISCIPLINARY],
        citation_style=CitationStyle.APA,
        publisher="PGPAUD Program, Faculty of Education, Universitas PGRI Semarang (UPGRIS)",
        country="Indonesia",
        language="Indonesian/English",
        columns=1,
        page_size="A4",
        ...
        supports_figures=True,
        supports_tables=True,
        special_sections=["Title (Indonesian & English)", "Author identity & affiliation", "Abstract (Indonesian & English)", "Keywords", "Introduction", "Method", "Results and Discussion", "Conclusion", "References"],
        notes="Jurnal Sinta 3 PAUD (UPGRIS). p-ISSN 2089-1431, e-ISSN 2598-4047. DOI prefix 10.26877. Single column, APA style. Font: Times New Roman 11pt body, 10pt abstract. Line spacing 1.5. 4 issue/tahun (Feb, Mei, Agu, Nov). Starting Vol 15 No 2 (May 2026) new template with adjusted citation style."
    ),
    "PGPAUDTRUNOJOYO": TemplateMetadata(
        code="PGPAUDTrunojoyo",
        name="PGPAUDTrunojoyo",
        full_name="Jurnal PG-PAUD Trunojoyo: Jurnal Pendidikan dan Pembelajaran Anak Usia Dini",
        template_type=TemplateType.JOURNAL,
        fields=[TemplateField.MULTIDISCIPLINARY],
        citation_style=CitationStyle.APA,
        publisher="Program Studi PG-PAUD, FKIP, Universitas Trunojoyo Madura",
        country="Indonesia",
        language="Indonesian/English",
        columns=1,
        page_size="A4",
        ...
        supports_figures=True,
        supports_tables=True,
        special_sections=["Title", "Author Name(s) and Affiliation", "Corresponding Author Email", "Abstract (Abstrak)", "Abstract (English)", "Keywords / Kata Kunci", "Introduction (Pendahuluan)", "Method (Metode)", "Results and Discussion (Hasil dan Pembahasan)", "Conclusion (Simpulan)", "References (Daftar Pustaka)"],
        notes="Jurnal Sinta 3 PAUD (Universitas Trunojoyo Madura). p-ISSN 2528-3553, e-ISSN 2613-9650. DOI prefix 10.21107. Single column, APA style. Font: Times New Roman 14pt title bold, 12pt body, 10pt abstract. Margin: left 40mm, right 30mm, top 30mm, bottom 30mm. Single spacing. 2 issue/tahun. APC Rp 300.000."
    ),
}
