#!/usr/bin/env python3
"""Generate hasil.json dengan multiple keywords menggunakan semua working fetchers"""
...
from tools.Literatur.fetchers import openalex, crossref, pubmed, europepmc, dblp, sinta
from tools.Literatur.http_client import get_client

# All working fetchers
FETCHERS = {
    "openalex": openalex,
    "crossref": crossref,
    "pubmed": pubmed,
...
def main():
    print("""
╔══════════════════════════════════════════════════════════════════════╗
║           GENERATE HASIL.JSON - MULTI-KEYWORD SEARCH                 ║
║           Using all 6 working fetchers                               ║
╚══════════════════════════════════════════════════════════════════════╝
""")
