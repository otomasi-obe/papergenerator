...
class PlaywrightMCPRunner:
    ...
    def record_result(self, test_name: str, passed: bool, message: str = ""):
        ...
        self.test_results.append(
            {"test": test_name, "passed": passed, "message": message, "timestamp": time.time()}
        )
...
TEST_SCENARIOS = {
    "beginner": {
        ...
        "steps": [
            ...
            {"action": "snapshot", "description": "Take initial snapshot to see login page"},
            {
                "action": "click",
            ...
            {"action": "click", "element": "submit button", "description": "Submit login form"},
            {
                "action": "wait",
            ...
            {"action": "snapshot", "description": "Verify we're on dashboard"},
            {"action": "click", "element": "New Paper button", "description": "Create new paper"},
            {
                "action": "wait",
            ...
            {"action": "snapshot", "description": "Verify editor page with chat interface"},
            {
                "action": "type",
            ...
            {"action": "snapshot", "description": "Capture AI response"},
            {
                "action": "verify",
            ...
            {"action": "snapshot", "description": "Verify generation in progress"},
            {
                "action": "wait",
            ...
            {"action": "snapshot", "description": "Verify paper was generated"},
            {
                "action": "verify",
    ...
    "intermediate": {
        ...
        "steps": [
            ...
            {"action": "create_paper", "description": "Create new paper"},
            {
                "action": "type",
                "element": "chat input",
