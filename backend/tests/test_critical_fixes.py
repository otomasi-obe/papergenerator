...
class TestQuotaRaceCondition:
    ...
    def test_concurrent_quota_updates(self, client, test_user):
        ...
        def log_usage():
            _log_api_usage(
                endpoint='test',
                usage={'total_tokens': tokens_per_request, 'prompt_tokens': 500, 'completion_tokens': 500},
                user_id=test_user
            )
        ...
        with app.app_context():
            ...
            assert user.token_used_month == expected_total, \
...
class TestSemaphoreLeak:
    ...
    def test_semaphore_released_on_timeout(self, client):
        ...
        try:
            ...
            assert _upstream_sem._value == initial_value, \
...
class TestConnectionPoolExhaustion:
    ...
    def test_long_poll_releases_connection(self, client, test_user):
        ...
        from slr_bp import wait_slr_jobs
