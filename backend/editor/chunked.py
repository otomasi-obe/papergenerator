...
from editor.api_client import _call_aiotomasi_with_fallback
...
def _load_full_context(
    paper_id, conv_id=None, max_files=5, max_lit=20, history_msgs=10, custom_prompt=None, review_mode=False, user_id=None
):
...
def _generate_outline(
    ...
    context_block = _load_full_context(
        paper_id, conv_id, max_files=5, max_lit=20, history_msgs=10, 
