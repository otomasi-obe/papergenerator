...
def _configure_logging(log_file: Path) -> None:
    from utils.core.hourly_log_handler import HourlyFileHandler, HourlyJSONFormatter
    fmt = HourlyJSONFormatter()
    ...
    file_h = HourlyFileHandler(str(log_dir), log_file.name, level=logging.INFO)
...
def init_observability(app: Flask, db, *, log_file: Path) -> None:
    ...
    _configure_logging(log_dir / log_file.name)
