...
def upgrade() -> None:
    ...
    with op.batch_alter_table('papers') as batch_op:
        ...
        batch_op.create_foreign_key(
            'papers_user_id_fkey', 'users', ['user_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('paper_images') as batch_op:
        ...
        batch_op.create_foreign_key(
            'paper_images_paper_id_fkey', 'papers', ['paper_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('paper_images') as batch_op:
        ...
        batch_op.create_foreign_key(
            'paper_images_user_id_fkey', 'users', ['user_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('paper_files') as batch_op:
        ...
        batch_op.create_foreign_key(
            'paper_files_paper_id_fkey', 'papers', ['paper_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('paper_files') as batch_op:
        ...
        batch_op.create_foreign_key(
            'paper_files_user_id_fkey', 'users', ['user_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('conversations') as batch_op:
        ...
        batch_op.create_foreign_key(
            'conversations_paper_id_fkey', 'papers', ['paper_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('project_memory') as batch_op:
        ...
        batch_op.create_foreign_key(
            'project_memory_paper_id_fkey', 'papers', ['paper_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('project_memory') as batch_op:
        ...
        batch_op.create_foreign_key(
            'project_memory_user_id_fkey', 'users', ['user_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('ai_jobs') as batch_op:
        ...
        batch_op.create_foreign_key(
            'ai_jobs_user_id_fkey', 'users', ['user_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('ai_jobs') as batch_op:
        ...
        batch_op.create_foreign_key(
            'ai_jobs_paper_id_fkey', 'papers', ['paper_id'], ['id'],
            ondelete='SET NULL'
        )
    ...
    with op.batch_alter_table('literature_items') as batch_op:
        ...
        batch_op.create_foreign_key(
            'literature_items_user_id_fkey', 'users', ['user_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('slr_jobs') as batch_op:
        ...
        batch_op.create_foreign_key(
            'slr_jobs_user_id_fkey', 'users', ['user_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('slr_jobs') as batch_op:
        ...
        batch_op.create_foreign_key(
            'slr_jobs_paper_id_fkey', 'papers', ['paper_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('image_gen_jobs') as batch_op:
        ...
        batch_op.create_foreign_key(
            'image_gen_jobs_user_id_fkey', 'users', ['user_id'], ['id'],
            ondelete='CASCADE'
        )
    ...
    with op.batch_alter_table('image_gen_jobs') as batch_op:
        ...
        batch_op.create_foreign_key(
            'image_gen_jobs_paper_id_fkey', 'papers', ['paper_id'], ['id'],
            ondelete='CASCADE'
        )
