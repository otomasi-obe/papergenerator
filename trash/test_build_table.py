...
def build(user_prompt):
    ...
    for i in range(1, len(segments), 2):
        ...
        metrics_str = re.split(r'[.;]\s*(?:\w|$)', metrics_str)[0].strip()
...
prompt_text = (
    'create an image "A combined bar and line chart" '
    ...
    'Config8 (12.6V 2200mAh 100cm/s): Daya=8.69W, Durasi=19min. '
    'The chart has a white background.'
)

tables, cols = build(prompt_text)
if tables:
