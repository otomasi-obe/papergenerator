...
TEST_USERS = {
    "beginner": {"username": "beginner_user", "password": "test123", "email": "beginner@test.com"},
    "intermediate": {
        "username": "intermediate_user",
        "password": "test123",
        "email": "intermediate@test.com",
    },
    "advanced": {"username": "advanced_user", "password": "test123", "email": "advanced@test.com"},
    "hybrid": {"username": "hybrid_user", "password": "test123", "email": "hybrid@test.com"},
    "default": {"username": "testuser", "password": "testpass", "email": "test@test.com"},
}
...
EXPECTED_KEYWORDS = {
    ...
    "advanced": {"initial_response": ["lengkap", "generate", "membuat", "siap", "mulai"]},
    "hybrid": {
...
ENVIRONMENTS = {
    "local": {"app_url": "http://localhost:5173", "api_url": "http://localhost:5000"},
    "staging": {
