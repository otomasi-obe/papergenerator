"""
JTAgen.py - Generator DOCX untuk jurnal JTA.
Menggunakan dokumen asli JTA.docx sebagai base template.
...
TEMPLATE_DOCX = BASE / "JTA.docx"
TEMPLATE_JSON = BASE / "_template.json"
OUTPUT_DOCX = BASE / "JTA_output.docx"

CFG = {
    "font_body": "Arial Nova",
    "font_title": "Arial Nova",
    "font_heading": "Arial Nova",
    "size_body": 10,
    "size_title": 14,
    "size_heading1": 10,
    "size_heading2": 10,
...
def add_figure(doc, fig_data, fig_counter):
    ...
    prompt_hint = _clean_latex(_clean_latex(str(fig_data.get("Prompt", "")).strip()
))
...
def add_table_element(doc, tbl_data, tbl_counter):
    ...
    title = _clean_latex(_clean_latex(str(tbl_data.get("Title", f"Table {tbl_no}")).strip()
))
