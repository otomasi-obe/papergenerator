"""
CERiMREgen.py - Generator DOCX untuk jurnal CERiMRE.
Menggunakan dokumen asli CERiMRE.docx sebagai base template.
...
TEMPLATE_DOCX = BASE / "CERiMRE.docx"
TEMPLATE_JSON = BASE / "_template.json"
OUTPUT_DOCX = BASE / "CERiMRE_output.docx"
...
def add_section_heading(doc, title):
    ...
    set_run_font(run, CFG["font_heading"], CFG["size_heading1"], bold=True, color=(0x94, 0x36, 0x34))
